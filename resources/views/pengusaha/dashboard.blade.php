    ...
    <x-slot name="navbarLogo">
        <div class="flex items-center h-full">
            <div>
                ...
                <p class="text-base font-bold text-white leading-tight">Dashboard</p>
            </div>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-lg p-4 border border-gray-200">
                <div class="flex items-start justify-between mb-4">
                    ...
                    <form method="POST" action="{{ route('pengusaha.toggle_status') }}"
                        ...
                        <span
                            class="text-sm font-medium {{ $umkm->is_open ? 'text-green-600' : 'text-red-600' }}">{{ $umkm->is_open ? 'Buka' : 'Tutup' }}</span>
                    </form>
                </div>
