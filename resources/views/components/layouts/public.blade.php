            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    @guest
                        ...
                        <a href="{{ route('register') }}" class="bg-indigo-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-indigo-700 transition">Daftar</a>
                    @endguest
                    ...
                    @auth
                        ...
                        @elseif(auth()->user()->role === 'pengusaha')
                            <a href="/mitra/dashboard" class="text-indigo-600 font-medium">Toko Saya</a>
                        @else
                            <a href="{{ route('dashboard') }}" class="text-gray-700 font-medium hover:text-indigo-600">Dashboard</a>
