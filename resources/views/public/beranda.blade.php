<x-layouts.public>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="text-center mb-12">
            ...
            <p class="mt-4 text-xl text-gray-500">Temukan gerai UMKM favorit di sekitar Anda yang sedang buka saat ini.
            </p>
        </div>
                ...
                <a href="{{ route('umkm.detail', $toko->slug) }}"
                    ...
                    <div class="p-5">
                        ...
                        <div class="mt-4 flex justify-between items-center">
                            ...
                            <span class="text-sm font-medium text-indigo-600 group-hover:underline">Lihat Menu
                                &rarr;</span>
                        </div>
                    </div>
                </a>
